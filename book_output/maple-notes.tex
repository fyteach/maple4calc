...
\begin{figure}
\centering
\includegraphics{figs/Rolletheorem.png}
...
\begin{figure}
\centering
\includegraphics{figs/MeanValueTheorem.png}
...
Consider the floor function \(f(x)=abs{x}\). Use a graph to show that there is no tangent line that is parallel to the secant line through \((-1, 1)\) and \((2,2)\).
\EndKnitrBlock{exercise}
...
In Maple, to find limits, we use the command \texttt{limit(f(x),\ x=a)} or \texttt{LimitTutor(f(x),\ x=a)} supported by \texttt{Student{[}Calculus1{]}.\ To\ find\ asymptotes,\ you\ may\ use\ the\ command}Asymptotes(f(x), x)\texttt{which\ is\ again\ supported\ by}Student{[}Calculus1{]}`.
...
On the other hand, we can sketch the graph using calculus, more precisely, monotonicity, concavity, vertical asymptote, horizontal asymptote, periods, symmetries, local extrema, intercepts etc.
...
\BeginKnitrBlock{example}
\protect\hypertarget{exm:unnamed-chunk-131}{}{\label{exm:unnamed-chunk-131} }Show the solid obtained by rotating the region bounded by \(y=x^2\) and \(y=x\) about \(y\)-axis. Set up an integral for the volume. Find the volume.
\EndKnitrBlock{example}
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-134}{}{\label{exr:unnamed-chunk-134} }Find the volume of the solid obtained by rotating the region bounded by \(y=x^3\), \(x=0\), \(y=1\) about \(y\)-axis
\EndKnitrBlock{exercise}

\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-135}{}{\label{exr:unnamed-chunk-135} }Find the volume of the solid obtained by rotating the region bounded by \(y=x^3\), \(y=0\), \(x=1\) about (a) \(y=0\), and (b) \(x=2\).
\EndKnitrBlock{exercise}
...
\BeginKnitrBlock{example}
\protect\hypertarget{exm:unnamed-chunk-138}{}{\label{exm:unnamed-chunk-138} }Find \((f^{-1})'(0)\), where \(f(x)=\cos(x)\) and \(0\leq x\leq \pi\).
\EndKnitrBlock{example}
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-143}{}{\label{exr:unnamed-chunk-143} }Graph the following functions together.
\[
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-144}{}{\label{exr:unnamed-chunk-144} }Graph the following functions together.
\[
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-145}{}{\label{exr:unnamed-chunk-145} }Graph the following functions together.
\[
...
\BeginKnitrBlock{example}
\protect\hypertarget{exm:unnamed-chunk-146}{}{\label{exm:unnamed-chunk-146} }Find \(y'\), where \(y=\ln \left(x^{3}+5x+1\right)\).
\EndKnitrBlock{example}
...
\BeginKnitrBlock{example}
\protect\hypertarget{exm:unnamed-chunk-148}{}{\label{exm:unnamed-chunk-148} }Evaluate the integral
\[
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-153}{}{\label{exr:unnamed-chunk-153} }
Evaluate the integral
\[
\int 2^{3x} d x
\]
...
\BeginKnitrBlock{example}
\protect\hypertarget{exm:unnamed-chunk-154}{}{\label{exm:unnamed-chunk-154} }Find the function \(f(x)\) which satisfies the differential equation \(f'(x)=k f(x)\) with \(f(0)=5\) and \(f(2)=3\).
\EndKnitrBlock{example}
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-162}{}{\label{exr:unnamed-chunk-162} }
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-165}{}{\label{exr:unnamed-chunk-165} }
Evaluate the integral
\[
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-179}{}{\label{exr:unnamed-chunk-179} }
Evaluate the integral
\[
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-183}{}{\label{exr:unnamed-chunk-183} }
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-185}{}{\label{exr:unnamed-chunk-185} }
Find the sum of partial fraction and evaluate the integral
...
\BeginKnitrBlock{example}
\protect\hypertarget{exm:unnamed-chunk-186}{}{\label{exm:unnamed-chunk-186} }
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-200}{}{\label{exr:unnamed-chunk-200} }
Find the first 20 partial sums \(s_k=\sum_{n=1}^{n}a_n\) of the infinite series
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-201}{}{\label{exr:unnamed-chunk-201} }
...
\BeginKnitrBlock{example}
\protect\hypertarget{exm:unnamed-chunk-210}{}{\label{exm:unnamed-chunk-210} }
Plot the function
\[
