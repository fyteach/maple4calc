...
![Graph of some logarithmic and exponential functions](figs/Log-Exp-Functions-01.png){width=50%}
...
![](figs/DiffTutor-ex.png){width=50%}
...
![Graph of the tangent and arctangent functions](figs/InversePlot_tanx.png){width=50%}
